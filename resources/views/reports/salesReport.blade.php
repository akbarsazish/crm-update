            ...
            <fieldset class="border rounded sidefieldSet">
                ...
                <form action="{{url('/getSalesReportInfo')}}" method="get" id='salesReportForm'>
                    ...
                    <div class="form-group col-sm-12 mb-1">
                        ...
                        <select class="form-select form-select-sm" name="adminId" id="AllByAdmin">
                            <option value=""> همه</option>
                            <option value="00000000000000">بدون پشتیبان</option>
                            @foreach($poshtibans as $poshtiban)
                            <option value="{{$poshtiban->id}}">{{$poshtiban->name.' '.$poshtiban->lastName}}</option>
                            @endforeach
                        </select>
                    </div>

                    <div class="form-group col-sm-12 mb-1">
                        <label for="" class="form-label">نوع فاکتور</label>
                        <select class="form-select form-select-sm" name="factType" id="factType">
                            <option value=""> همه</option>
                            <option value="3"> فروش </option>
                            <option value="4"> برگشتی </option>
                        </select>
                    </div>
