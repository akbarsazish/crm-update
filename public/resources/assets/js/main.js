...
$(".crmCalculator").addClass("container-light");
...
$("input[type='checkbox']").change(function () {
    ...
    if (this.checked) {
        //alert("dark");
        $(".crmCalculator").removeClass("container-light");
        $(".crmCalculator").addClass("container-dark");
    ...
    // light theme (default)
        ...
        //alert("light");
        $(".crmCalculator").removeClass("container-dark");
        $(".crmCalculator").addClass("container-light");
